...
using the per-conformer values already computed by ``study_kraken_dft_scaled.py``.
...
from study_kraken_dft_reproduction import API_BASE, r_squared
...
def write_report(
    ...
    lines += [
        ...
        "descriptor. Generated by `study_kraken_vbur_family.py`.*",
        "",
    ]
