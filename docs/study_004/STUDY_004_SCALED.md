...
| Conformers | 31605 |
| R² vs published (1:1) | 0.9649 |
| Pearson r | 0.9823 |
| RMSE | 0.7552 Å³ |
| Median absolute error | 0.1112 Å³ |
...
published descriptor with `R^2 = 0.9649` (median absolute error
0.1112 Å³). This generalizes the eleven-ligand Study 004
...
are from the public MolSSI Kraken descriptor-library REST API (`https://descriptor-libraries.molssi.org/api/kraken`).
