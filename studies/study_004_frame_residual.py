...
import numpy as np
import pandas as pd
from study_004_reproduction import OFFICIAL_FEATURE, r_squared
from study_004_scaled import BOND_TOLERANCE_FACTOR, _covalent_radius
...
def write_report(table: pd.DataFrame, totals: dict[str, float], output: Path) -> None:
    ...
    lines += [
        ...
        "(bars = class means). Generated by `studies/study_004_frame_residual.py`.*",
        "",
    ]
