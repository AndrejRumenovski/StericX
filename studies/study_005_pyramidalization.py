...
1,541-ligand set validated by ``studies/study_004_scaled.py``.
...
import numpy as np
import pandas as pd
from study_004_reproduction import API_BASE, ensure_binary, r_squared
...
def write_report(
    ...
    lines += [
        ...
        "`studies/study_005_pyramidalization.py`.*",
        "",
    ]
