...
def main():
    out=ROOT/'prepared';out.mkdir(exist_ok=False)
        ...
        for ligand in ligands:
            ...
            for cid in ligand['conformer_ids']:
                ...
                try:
                    ...
                    if not heavy:raise ValueError('independent_topology_no_heavy_neighbor')
                    reference=heavy[0]
